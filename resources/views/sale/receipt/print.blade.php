...
<body>
  <div class="container-fluid">
            <div class="row">
                <div class="col-xs-10">
{{--                     <img src="{{ asset('img/secound_logo.png') }}" width="90px" height="75px"> --}}
     ...
     <div class="row" style="border: 1px solid black!important; margin-top: 3px; font-size: 12px;">
        <div class="col-xs-12">
            <div class="row">
    ...
    <div class="row">
        ...
        <table class="table table-bordered body-table  text-center" style="margin-top: 5px; margin-bottom: 1px !important; font-size: 9px;">
            <thead>
            <tr>
