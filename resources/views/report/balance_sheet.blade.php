...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Retailer Payment</h3>
                </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="inventory-table">
                                    ...
                                    <tr>
                                        <th colspan="2"></th>
                                        <th class="text-right">Total</th>
                                        <th class="text-right">{{ number_format($totalInventory, 2) }}</th>
                                    </tr>
                                    </tfoot>
                                </table>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="inventory-table">
                                    <thead>
                                    <tr>
                                        <th>Total Capital: {{ number_format($bankAccounts->sum('balance') + $cash->amount + $mobileBanking->amount + $customerTotalPaid + $totalInventory - $suppliers->sum('due'), 2) }}</th>
                                    </tr>
                                    </thead>
                                </table>
                            </div>
    ...
    <script>
        $(function () {
            ...
            $('#inventory-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('shop_purchase_inventory.datatable') }}',
                columns: [
