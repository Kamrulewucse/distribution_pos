                ...
                <form class="form-horizontal" method="POST" action="{{ route('supplier.edit', ['supplier' => $supplier->id]) }}">
                    ...
                    <div class="box-body">
                        <div class="form-group {{ $errors->has('name') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="Enter Name" name="name" value="{{ empty(old('name')) ? ($errors->has('name') ? '' : $supplier->name) : old('name') }}">
                        ...
                        <div class="form-group {{ $errors->has('opening_due') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="Enter Opening Due."
                                       name="opening_due" value="{{ empty(old('opening_due')) ? ($errors->has('address')? '' : $supplier->opening_due) : old('opening_due') }}">
